...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=50,minMessage="Votre contenu doit faire plus de 50 caractères")
     */
    private $content;
     ...
     * permet la validation les images du sous-formulaire (du CollectionType)
     * @Assert\Valid()
     */
    private $images;
    ...
    /**
     * Permet d'initialiser le slug avant de persister l'entity ou de la mettre à jour.
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * 
     * @return void
